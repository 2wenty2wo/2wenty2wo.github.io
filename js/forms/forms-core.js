 ...
 * Forms Core Module
 *
 * Contains the majority of form handling functions including:
 * - Hardware type picker
 * - Electrical component value pickers
 * - Fuse pickers
 * - Hardware pickers (bolt, nut, washer, switch)
 * - Connector pickers
 * - Custom graphics handling
 * - Standards filtering
