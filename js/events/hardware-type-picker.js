...
export function updateHardwareTypePickerMode() {
...
export function getHardwareTypeOptionElements() {
...
export function updateHardwareTypeActiveOptionFromDom() {
...
export function updateHardwareTypeTrapElements() {
  if (!hardwareTypePickerSurface) {
...
export function focusHardwareTypeOption(option) {
  if (!option) {
    return;
  }
  const options = getHardwareTypeOptionElements();
...
export function focusHardwareTypeDefaultOption() {
  const options = getHardwareTypeOptionElements();
  if (options.length === 0) {
...
export function moveHardwareTypeOption(delta) {
  const options = getHardwareTypeOptionElements();
  if (options.length === 0) {
    return;
  }
...
export function handleHardwareTypeDialogCancel(event) {
...
export function selectHardwareTypeOption(value) {
...
export function queueHardwareTypeSearchUpdate(value) {
  if (hardwareTypeSearchTimeoutId) {
    window.clearTimeout(hardwareTypeSearchTimeoutId);
  }
